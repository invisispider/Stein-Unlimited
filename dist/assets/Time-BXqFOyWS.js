import { a8 as defineStore, Z as reactive, r as ref, C as computed, P as onUnmounted, a9 as watchEffect, aa as toRefs, d as defineComponent, h as createElementBlock, j as createBaseVNode, F as createStaticVNode, Q as Fragment, S as renderList, n as withModifiers, D as normalizeClass, l as unref, t as toDisplayString, y as openBlock, a2 as watch, q as createTextVNode, k as createCommentVNode, ab as nextTick, ac as h, ad as isRef, o as onMounted, m as createVNode, p as withCtx, ae as Transition, X as createBlock } from "./index-BBZgqMci.js";
import { u as useMonitorSize } from "./monitor-size-ExHOgnku.js";
import { i as injectMarkdown } from "./injectMarkdown-C1QkDyKF.js";
const _imports_0 = "/assets/unlimitedtime-D3L3pPAe.webp";
...
const useTime = defineStore("time", () => {
  ...
  const state = reactive({
    ...
    habitNum: 0,
    dayNum: 0,
    zYear: (/* @__PURE__ */ new Date()).getFullYear() + 10001,
    dayOfHabit: 0,
    inputDate: null
  });
  ...
  const updateTime = async (dateOverride = null) => {
  ...
  function animateToSelectedDate(to) {
    stopAnimation();
    stopTimer();
    const from = DateTime.fromJSDate(state.now);
    const diff2 = to.diff(from, ["milliseconds"]).milliseconds;
    if (!isFinite(diff2)) return;
    const duration2 = 1e3;
    const interval = 16;
    const frames = Math.ceil(duration2 / interval);
    let frame = 0;
  ...
  function animateBackToNow(from) {
    stopAnimation();
    stopTimer();
    const to = DateTime.now();
    const diff2 = to.diff(from, ["milliseconds"]).milliseconds;
    if (!isFinite(diff2) || diff2 <= 0) {
      updateTime();
      startTimer();
      return;
    }
    const duration2 = Math.min(diff2, 2e3);
    const frames = Math.max(1, Math.floor(duration2 / 33));
    const step = diff2 / frames;
    let frame = 0;
    animationTimerID.value = setInterval(() => {
      frame++;
  ...
  function daysBetween(a, b) {
    ...
    return Math.floor((utcA - utcB) / 864e5);
  }
  function isLeapYear2() {
    const y = state.now.getFullYear();
    return y % 4 === 0 && y % 100 !== 0 || y % 400 === 0;
  }
  function getZenGap(year) {
  ...
  function getZenCycle(now2) {
    const year = now2.getFullYear();
    const thisGap = getZenGap(year);
    const prevGap = getZenGap(year - 1);
    const candidates = [prevGap, thisGap];
    const cycle = candidates.filter((g) => now2 >= g.start).sort((a, b) => b.start.getTime() - a.start.getTime())[0];
    return cycle;
  }
  const zenYearAnchor = ref(null);
  ...
  watchEffect(() => {
    ...
    const isZen = d >= 360;
    const gapDay = isZen ? Math.max(0, Math.min(d - 360, ctx.gap.length - 1)) : d;
    Object.assign(state, {
...
const _hoisted_2$3 = {
  id: "year-anim-clock-hand",
  class: "year-clock-hand"
};
const _hoisted_3$3 = ["transform"];
const _hoisted_4$3 = ["x", "y", "onClick"];
const _hoisted_5$3 = {
  x: "200",
  y: "300",
  class: "habit-names",
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const angle = computed(() => {
      if (store.dayOfYear >= 360) return 0;
      return store.dayOfYear / 360 * 360;
    });
    function goToHabit(habitIndex) {
      const now2 = DateTime.fromJSDate(store.now);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: "zenwheel pointer",
        style: { "cursor": "pointer" },
        onClick: _cache[1] || (_cache[1] = ($event) => emit("year"))
      }, [
        (openBlock(), createElementBlock("svg", {
          ...
          createBaseVNode("g", _hoisted_2$3, [
            _cache[2] || (_cache[2] = createBaseVNode("title", null, "This is which day it is in the current year.", -1)),
            _cache[3] || (_cache[3] = createBaseVNode("marker", {
              id: "arrow",
              viewBox: "0 0 10 10",
              refX: "3",
              refY: "3",
              ...
              createBaseVNode("path", { d: "M 0 0 L 6 3 L 0 6 z" })
            ], -1)),
            createBaseVNode("line", {
              ...
              transform: `rotate(${angle.value} 200 300)`
            }, null, 8, _hoisted_3$3)
          ]),
          ...
          _cache[10] || (_cache[10] = createBaseVNode("text", { class: "year-markers" }, "EQUINOX", -1)),
          createBaseVNode("g", {
            onClick: _cache[0] || (_cache[0] = ($event) => emit("year"))
          }, [
            _cache[4] || (_cache[4] = createBaseVNode("title", null, "Like Months, Habits divide the year into 45-day periods.", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(store).habitNames.slice(0, 8), (habit, i) => {
              return openBlock(), createElementBlock("g", { key: i }, [
                createBaseVNode("text", {
                  class: normalizeClass(unref(store).habitNum === i ? "active" : ""),
                  "text-anchor": "middle",
                  "dominant-baseline": "middle",
                  x: 200 + Math.cos((i * 45 + 22.5 - 90) * Math.PI / 180) * 120,
                  y: 300 + Math.sin((i * 45 + 22.5 - 90) * Math.PI / 180) * 120,
                  style: { "cursor": "pointer" },
                  onClick: withModifiers(($event) => goToHabit(i), ["stop"])
                }, toDisplayString(habit), 11, _hoisted_4$3)
              ]);
            }), 128))
          ]),
          _cache[11] || (_cache[11] = createBaseVNode("circle", {
            class: "bisque",
            r: 62,
            cx: 200,
            cy: 300,
          ...
          _cache[12] || (_cache[12] = createBaseVNode("g", null, [
            createBaseVNode("title", null, "Five-day Holiday festival Cycle considered off the calendar."),
            createBaseVNode("text", {
              x: "198",
              y: "160",
              style: { "z-index": "200" }
          ...
          createBaseVNode("circle", {
            ...
            "stroke-dasharray": "0 350 9 85",
            style: { "cursor": "pointer" },
            onClick: withModifiers(goToZen, ["stop"])
          })
        ], 8, _hoisted_1$4))
      ]);
    };
...
const _hoisted_1$3 = { class: "day-container" };
const _hoisted_2$2 = { class: "clock-container" };
const _hoisted_3$2 = ["width"];
const _hoisted_4$2 = ["width", "height"];
const _hoisted_5$2 = ["width"];
...
const _hoisted_12$1 = ["y", "width", "height"];
const _hoisted_13$1 = ["y", "width", "height"];
const _hoisted_14$1 = ["x", "y", "textContent"];
const _hoisted_15$1 = {
  id: "zenMeter",
  fill: "none"
};
const _hoisted_16$1 = ["onClick"];
const _hoisted_17$1 = ["x", "y", "width", "height"];
const _hoisted_18 = ["x", "y"];
const _hoisted_19 = {
  id: "clockHand",
  fill: "none"
};
const _hoisted_20 = ["y1", "x2", "y2"];
const _hoisted_21 = ["transform"];
const _hoisted_22 = ["d"];
const _hoisted_23 = ["x", "y"];
const _hoisted_24 = ["x", "y"];
const _hoisted_25 = ["cx", "cy"];
const _hoisted_26 = ["cx", "cy"];
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "ZenDay",
  emits: ["clock", "moment", "instant"],
  setup(__props, { emit: __emit }) {
    ...
    function generateSunPath(width, height, amplitudeRatio = 0.35, steps = 100) {
    ...
    function getSunPoint(width, height, t, amplitudeRatio = 0.35) {
      const centerX = width / 2;
      const amplitude = width * amplitudeRatio;
      return {
    ...
    function getWavePoint(t, width, height, amplitudeRatio = 0.35) {
      const centerX = width / 2;
      const amplitude = width * amplitudeRatio;
      return {
        x: centerX - amplitude * Math.sin(2 * Math.PI * t),
    ...
    function goToSession(eventIndex) {
      const now2 = DateTime.fromJSDate(store.now);
      const zenStart = getZenDayStart(now2);
      const instantOfDay = eventIndex * 1e4;
      const target = zenStart.plus({ seconds: instantOfDay });
      store.animateToSelectedDate(target);
    }
    function getZenDayStart(dt) {
      const sixAM = dt.set({ hour: 6, minute: 0, second: 0, millisecond: 0 });
      return dt < sixAM ? sixAM.minus({ days: 1 }) : sixAM;
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("div", _hoisted_2$2, [
          (openBlock(), createElementBlock("svg", {
            ...
            createBaseVNode("g", {
              style: { "cursor": "pointer" },
              onClick: _cache[0] || (_cache[0] = ($event) => emit("clock"))
            }, [
              _cache[4] || (_cache[4] = createBaseVNode("title", null, "This chart shows what time of day it is now.", -1)),
              createBaseVNode("rect", {
                width: svgWidth.value,
                height: svgHeight.value / 5,
                class: "daytop-bg"
              }, null, 8, _hoisted_4$2),
              _cache[5] || (_cache[5] = createBaseVNode("text", {
                height: 20,
                x: "50%",
                y: "20",
                "text-anchor": "middle",
                class: "greg-text",
                textContent: "Session Clock"
              }, null, -1))
            ]),
            createBaseVNode("g", {
              onClick: _cache[1] || (_cache[1] = ($event) => emit("moment"))
            }, [
              _cache[6] || (_cache[6] = createBaseVNode("title", null, "Our version of Minutes", -1)),
              createBaseVNode("rect", {
                width: svgWidth.value / 9 * Sewmi.value.event || 0,
                height: 20,
                y: 30,
                class: "inner-rect"
              }, null, 8, _hoisted_5$2),
              createBaseVNode("rect", {
                width: svgWidth.value / 100 * (10 * Sewmi.value.session + Sewmi.value.while) || 0,
                height: 6,
                y: 45,
                class: "alt-fill"
              }, null, 8, _hoisted_6$1),
              createBaseVNode("text", _hoisted_7$1, " SEW: " + toDisplayString(String(Sewmi.value.event)) + "`" + toDisplayString(String(Sewmi.value.session)) + toDisplayString(String(Sewmi.value.while)), 1)
            ]),
            createBaseVNode("g", {
              onClick: _cache[2] || (_cache[2] = ($event) => emit("instant"))
            }, [
              _cache[7] || (_cache[7] = createBaseVNode("title", null, "Our version of Seconds", -1)),
              createBaseVNode("rect", {
                y: 57,
                class: "inner-rect",
                width: svgWidth.value / 100 * Number(String(unref(store).instantOfDay).slice(3)),
                height: 20
              }, null, 8, _hoisted_8$1),
              createBaseVNode("text", _hoisted_9$1, "MI: " + toDisplayString(String(Sewmi.value.moment)) + toDisplayString(String(Sewmi.value.instant)), 1)
            ])
          ], 8, _hoisted_3$2)),
          (openBlock(), createElementBlock("svg", {
            width: svgWidth.value,
            ...
            style: { "cursor": "pointer" },
            onClick: _cache[3] || (_cache[3] = ($event) => emit("clock"))
          }, [
            createBaseVNode("g", _hoisted_11$1, [
              _cache[8] || (_cache[8] = createBaseVNode("title", null, "Hours compared to Sessions", -1)),
              (openBlock(), createElementBlock(Fragment, null, renderList(25, (num, i) => {
                return openBlock(), createElementBlock(Fragment, {
                  key: num + 100
                }, [
                  i < 6 || i > 17 ? (openBlock(), createElementBlock("rect", {
                    key: 0,
                    y: rSpread.value * i,
                    class: "greg-dark",
                    width: gregWidth.value,
                    height: svgHeight.value / 24
                  }, null, 8, _hoisted_12$1)) : (openBlock(), createElementBlock("rect", {
                    key: 1,
                    y: rSpread.value * i,
                    class: "greg-light",
                    width: gregWidth.value,
                  ...
                  createBaseVNode("text", {
                    x: svgWidth.value / 100,
                    y: i * rSpread.value - 0.15 * rSpread.value,
                    class: "greg-number",
                    textContent: toDisplayString((48 - i + 6) % 24)
                  }, null, 8, _hoisted_14$1)
                ], 64);
              }), 64))
            ]),
            createBaseVNode("g", _hoisted_15$1, [
              _cache[9] || (_cache[9] = createBaseVNode("title", null, "Our version of Hours dividing the day into Sessions", -1)),
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(store).EventNames, (zses, j) => {
                return openBlock(), createElementBlock("g", {
                  key: j + 200,
                  style: { "cursor": "pointer" },
                  onClick: withModifiers(($event) => goToSession(8 - j), ["stop"])
                }, [
                  createBaseVNode("rect", {
                    x: gregWidth.value,
                    y: zenSpread.value + zSpread.value * j - zSpread.value,
                    width: halfWidth.value,
                    height: zSpread.value,
                    class: normalizeClass(["zen-borders", 8 - j <= Number(Sewmi.value.event) ? "session-before" : "session-after"])
                  }, null, 10, _hoisted_17$1),
                  createBaseVNode("text", {
                    x: svgWidth.value / 4,
                    y: j * zSpread.value + zSpread.value / 3,
                    class: normalizeClass(["zen-mint", { sessionActive: 8 - j == Sewmi.value.event }])
                  }, toDisplayString(j !== 0 ? 8 - j : "") + " " + toDisplayString(unref(store).EventNames[8 - j]), 11, _hoisted_18)
                ], 8, _hoisted_16$1);
              }), 128))
            ]),
            createBaseVNode("g", _hoisted_19, [
              createBaseVNode("line", {
                x1: "0",
                y1: hou_height.value,
                x2: halfWidth.value + gregWidth.value,
                y2: hou_height.value,
                class: "clock-hand"
              }, null, 8, _hoisted_20)
            ]),
            createBaseVNode("g", {
              transform: `translate(${gregWidth.value}, 0)`
            }, [
              createBaseVNode("path", {
                d: generateSunPath(svgWidth.value * 0.9, svgHeight.value),
                stroke: "#ccc",
                "stroke-width": "2",
                fill: "none",
                opacity: "0.4"
              ...
              createBaseVNode("circle", {
                cx: wavePoint.value.x,
                cy: wavePoint.value.y,
                r: "4",
                class: "time-dot"
              }, null, 8, _hoisted_25),
              createBaseVNode("circle", {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const zenLength = computed(() => {
      var _a, _b;
      return ((_b = (_a = store.zenContext) == null ? void 0 : _a.gap) == null ? void 0 : _b.length) ?? 5;
    });
    watch(
      () => store.zenContext,
      (ctx) => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", {
        id: "habits",
        onClick: _cache[0] || (_cache[0] = ($event) => emit("calendar"))
      }, [
        createBaseVNode("div", {
          ref_key: "calendarRef",
          ref: calendarRef,
          ...
          createBaseVNode("h2", null, toDisplayString(unref(store).habitName), 1),
          unref(store).habitName !== "~newZen~" ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(store).dayNames, (day) => {
              return openBlock(), createElementBlock("div", {
                key: day,
                class: "baheader baheader-zen"
              }, toDisplayString(day), 1);
            }), 128)),
            (openBlock(), createElementBlock(Fragment, null, renderList(45, (d) => {
              return createBaseVNode("div", {
                key: d,
                class: normalizeClass(["uncell uncell-zen", d === unref(store).dayOfHabit + 1 ? "selected-date" : ""]),
                style: { "cursor": "pointer" },
                onClick: ($event) => goToDay(d - 1)
              }, [
                d === 1 ? (openBlock(), createElementBlock("i", _hoisted_3$1, "self_improvement")) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(zenLength.value, (d) => {
              return openBlock(), createElementBlock("div", {
                key: d,
                class: normalizeClass(["uncell uncell-zen", d - 1 === unref(store).dayOfHabit ? "selected-date" : ""]),
                style: { "cursor": "pointer" },
                onClick: ($event) => unref(store).isLeapYear() ? goToZenDay(d - 7) : goToZenDay(d - 6)
              }, _cache[1] || (_cache[1] = [
                createBaseVNode("i", { class: "material-icons holiday" }, "self_improvement", -1)
              ]), 10, _hoisted_5$1);
            }), 128))
          ]))
        ], 544)
...
const _hoisted_1$1 = { class: "conversion-table" };
const _sfc_main$1 = {
  __name: "TimeConversions",
  props: ["showChart"],
  emits: ["clock", "calendar"],
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emit = __emit;
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        props.showChart == "clock" ? (openBlock(), createElementBlock("table", {
          key: 0,
          style: { "cursor": "pointer" },
          onClick: _cache[0] || (_cache[0] = ($event) => emit("clock"))
        }, _cache[2] || (_cache[2] = [
          createBaseVNode("tbody", null, [
            createBaseVNode("tr", null, [
              createBaseVNode("th", { colSpan: "4" }, "SEWMI Clock")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th-blue" }, "Day"),
              createBaseVNode("th", { class: "th-blue" }, "8.64 Events")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "Event"),
              createBaseVNode("th", { class: "th" }, "10 Sessions")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "Session"),
              createBaseVNode("th", { class: "th" }, "10 Whiles")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "While"),
              createBaseVNode("th", { class: "th" }, "10 Moments")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "Moment"),
              createBaseVNode("th", { class: "th" }, "10 Instants")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "Instant"),
              createBaseVNode("th", { class: "th" }, "=Second")
            ])
          ], -1)
        ]))) : createCommentVNode("", true),
        props.showChart == "habit" ? (openBlock(), createElementBlock("table", {
          key: 1,
          style: { "cursor": "pointer" },
          onClick: _cache[1] || (_cache[1] = ($event) => emit("calendar"))
        }, _cache[3] || (_cache[3] = [
          createBaseVNode("tbody", null, [
            createBaseVNode("tr", null, [
              createBaseVNode("th", { colSpan: "4" }, "Calendar Date")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "newZen"),
              createBaseVNode("th", { class: "th" }, "~5 Days")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "Historical Era"),
              createBaseVNode("th", { class: "th" }, "10,000 BC")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "Year"),
              createBaseVNode("th", { class: "th" }, "8 Habits")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "Habit"),
              createBaseVNode("th", { class: "th" }, "45 Days")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th" }, "Cycle"),
              createBaseVNode("th", { class: "th" }, "5 Days")
            ]),
            createBaseVNode("tr", null, [
              createBaseVNode("th", { class: "th-blue" }, "Year"),
              createBaseVNode("th", { class: "th-blue" }, "360 Days")
            ])
          ], -1)
        ]))) : createCommentVNode("", true)
      ]);
...
const _hoisted_1 = {
  id: "zen-wrapper",
  class: "zen-wrapper",
  "data-test-id": "zen-wrapper"
};
const _hoisted_2 = { class: "time-gui-container" };
const _hoisted_3 = { class: "time-title-inset" };
const _hoisted_4 = { class: "time-widget time-info-widget" };
const _hoisted_5 = { class: "smiley" };
const _hoisted_6 = { key: 0 };
const _hoisted_7 = {
  key: 1,
  class: "pedantic"
};
const _hoisted_8 = { class: "time-info-buttons" };
const _hoisted_9 = { class: "content-selector" };
const _hoisted_10 = {
  id: "content-section",
  class: "content"
};
          ...
          createBaseVNode("div", _hoisted_3, [
            createVNode(Transition, {
              ...
              default: withCtx(() => _cache[19] || (_cache[19] = [
                createBaseVNode("img", {
                  src: _imports_0,
                  alt: "unlimited time timelogo",
                  class: "theme-image unlimited-time-logo"
                }, null, -1)
              ])),
              _: 1
            }),
            createBaseVNode("p", null, toDisplayString(unref(store).forma), 1),
            createBaseVNode("p", {
              class: "readout",
              style: { "font-weight": "bold", "cursor": "pointer" },
              onClick: _cache[0] || (_cache[0] = ($event) => toggleShow("reading"))
            }, toDisplayString(unref(store).displayZenTime) + " " + toDisplayString(unref(store).displayZenDate), 1)
          ]),
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("div", _hoisted_5, [
              _cache[20] || (_cache[20] = createBaseVNode("h4", null, "Time Travel", -1)),
              unref(store).isFlowing ? (openBlock(), createElementBlock("p", _hoisted_6, "Current Time")) : (openBlock(), createElementBlock("p", _hoisted_7, "Time Stopped")),
              createVNode(unref(Component), {
                modelValue: unref(store).inputDate,
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(store).inputDate = $event),
                placeholder: "convert Roman date",
                config: flatpickrOptions
              }, null, 8, ["modelValue"]),
              createBaseVNode("button", { onClick: resetClock }, "Back to now")
            ]),
            createBaseVNode("div", _hoisted_8, [
              createBaseVNode("i", {
                class: normalizeClass(["material-icons", showChart.value == "clock" ? "active" : ""]),
                onClick: _cache[2] || (_cache[2] = ($event) => showChart.value = "clock")
              }, "watch_later", 2),
              createBaseVNode("i", {
                class: normalizeClass(["material-icons", showChart.value == "year" ? "active" : ""]),
                onClick: _cache[3] || (_cache[3] = ($event) => showChart.value = "year")
              }, "face", 2),
              createBaseVNode("i", {
                class: normalizeClass(["material-icons", showChart.value == "habit" ? "active" : ""]),
                onClick: _cache[4] || (_cache[4] = ($event) => showChart.value = "habit")
              }, "insert_invitation", 2)
            ]),
            showChart.value != "year" ? (openBlock(), createBlock(_sfc_main$1, {
              key: 0,
              showChart: showChart.value,
              onCalendar: _cache[5] || (_cache[5] = ($event) => toggleShow("calendar")),
              onClock: _cache[6] || (_cache[6] = ($event) => toggleShow("clock"))
            }, null, 8, ["showChart"])) : showChart.value == "year" ? (openBlock(), createBlock(_sfc_main$4, {
              key: 1,
              onYear: _cache[7] || (_cache[7] = ($event) => toggleShow("year"))
            })) : createCommentVNode("", true)
          ]),
          createVNode(_sfc_main$3, {
            class: "time-widget",
            onClock: _cache[8] || (_cache[8] = ($event) => toggleShow("clock")),
            onMoment: _cache[9] || (_cache[9] = ($event) => toggleShow("clock")),
            onInstant: _cache[10] || (_cache[10] = ($event) => toggleShow("clock"))
          }),
          createVNode(_sfc_main$2, {
            class: "time-widget",
            onCalendar: _cache[11] || (_cache[11] = ($event) => toggleShow("calendar"))
          })
        ]),
        _cache[21] || (_cache[21] = createBaseVNode("div", { style: { "text-align": "center", "padding-block": "1em" } }, [
          createBaseVNode("a", {
            href: "https://www.youtube.com/watch?v=0WahT7bJYMU",
            target: "_blank"
          }, "🎬 Watch unThinkMe's explainer video!")
        ], -1)),
        createBaseVNode("div", _hoisted_9, [
          createBaseVNode("div", {
            class: "content-button",
            onClick: _cache[12] || (_cache[12] = ($event) => toggleShow("INTRODUCTION"))
          }, "INTRODUCTION"),
          createBaseVNode("div", {
            class: "content-button",
            onClick: _cache[13] || (_cache[13] = ($event) => toggleShow("READING"))
          }, "READING"),
          createBaseVNode("div", {
            class: "content-button",
            onClick: _cache[14] || (_cache[14] = ($event) => toggleShow("YEAR"))
          }, "YEAR"),
          createBaseVNode("div", {
            class: "content-button",
            onClick: _cache[15] || (_cache[15] = ($event) => toggleShow("CALENDAR"))
          }, "CALENDAR"),
          createBaseVNode("div", {
            class: "content-button",
            onClick: _cache[16] || (_cache[16] = ($event) => toggleShow("CLOCK"))
          }, "CLOCK"),
          createBaseVNode("div", {
            class: "content-button",
            onClick: _cache[17] || (_cache[17] = ($event) => toggleShow("MOMENT"))
          }, "MOMENT"),
          createBaseVNode("div", {
            class: "content-button",
            onClick: _cache[18] || (_cache[18] = ($event) => toggleShow("INSTANT"))
          }, "INSTANT")
        ]),
        createBaseVNode("div", _hoisted_10, [
          createVNode(Transition, { name: "phase" }, {
            default: withCtx(() => [
              activePanel.value == "READING" ? (openBlock(), createElementBlock("div", {
                key: 0,
                innerHTML: unref(htmlREADING)
              }, null, 8, _hoisted_11)) : activePanel.value == "YEAR" ? (openBlock(), createElementBlock("div", {
                key: 1,
                innerHTML: unref(htmlYEAR)
              }, null, 8, _hoisted_12)) : activePanel.value == "CALENDAR" ? (openBlock(), createElementBlock("div", {
                key: 2,
                innerHTML: unref(htmlCALENDAR)
              }, null, 8, _hoisted_13)) : activePanel.value == "CLOCK" ? (openBlock(), createElementBlock("div", {
                key: 3,
                innerHTML: unref(htmlCLOCK)
              }, null, 8, _hoisted_14)) : activePanel.value == "MOMENT" ? (openBlock(), createElementBlock("div", {
                key: 4,
                innerHTML: unref(htmlMOMENT)
              }, null, 8, _hoisted_15)) : activePanel.value == "INSTANT" ? (openBlock(), createElementBlock("div", {
                key: 5,
                innerHTML: unref(htmlINSTANT)
              }, null, 8, _hoisted_16)) : (openBlock(), createElementBlock("div", {
                key: 6,
                class: "content",
                innerHTML: unref(htmlINTRODUCTION)
              }, null, 8, _hoisted_17))
            ]),
            _: 1
          })
