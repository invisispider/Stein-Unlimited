...
<template>
    ...
    <p><span class="pedantic">Click map elements for more information.</span>
        This map displays all major categories of conscious State experience,  
        illustrating the relationship between Ordinary States and a generalized progression 
        of meditative spiritual States. We also map UR Quadrant brainwave 
        states (electroencephalograph, EEG) to the described UL State experience.  
    </p>
    <!-- width="434.55936"
        height="480.71686" -->
    <svg
        ...
        <defs
            ...
            style="display:inline; border-radius:12px"><rect
            id="rect1"
            ...
            @click="emit('ordinary')"><tspan
                id="tspan12"
                sodipodi:role="line"
                x="318.96503"
                y="595.02509"
                style="font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:26.6667px;line-height:1.2;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';text-align:center;text-anchor:middle;fill-opacity:1;stroke:#000000;stroke-width:0;stroke-dasharray:none;stroke-opacity:1">ORDINARY</tspan></text><g
            id="g12"
            transform="translate(24.401287,-132.47546)"
            style="display:inline;fill-opacity:1"><text
                id="text8"
                xml:space="preserve"
                ...
                x="244.06317"
                y="544.85376"><tspan id="tspan8" class="hover-states"
                sodipodi:role="line"
                x="244.06317"
                y="544.85376"
                ...
                @click="emit('ordinary')">Sleep</tspan></text><text
                id="text9"
                xml:space="preserve"
                ...
                x="241.85153"
                y="457.25189"><tspan id="tspan9" class="hover-states"
                sodipodi:role="line"
                x="241.85153"
                y="457.25189"
                style="cursor:pointer; font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:18.6667px;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';fill-opacity:1;stroke:#000000;stroke-width:0;stroke-dasharray:none;stroke-opacity:1"
                @click="emit('ordinary')">Dreaming</tspan></text><text
                id="text10"
                xml:space="preserve"
                style="font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:18.6667px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';letter-spacing:0.92px;fill-opacity:1;stroke:#000000;stroke-width:0;stroke-dasharray:none;stroke-opacity:1"
                x="241.867"
                y="357.24945"><tspan id="tspan10" class="hover-states"
                sodipodi:role="line"
                x="241.867"
                y="357.24945"
                style="cursor:pointer; font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:18.6667px;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';fill-opacity:1;stroke:#000000;stroke-width:0;stroke-dasharray:none;stroke-opacity:1"
                @click="emit('ordinary')">Relaxing</tspan></text><text
                id="text11"
                xml:space="preserve"
                style="font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:18.6667px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';letter-spacing:0.92px;display:inline;fill-opacity:1;stroke:#000000;stroke-width:0;stroke-dasharray:none;stroke-opacity:1"
                x="243.61609"
                y="266.56757"><tspan id="tspan11" class="hover-states"
                sodipodi:role="line"
                x="243.61609"
                y="266.56757"
                style="cursor:pointer; font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:18.6667px;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';fill-opacity:1;stroke:#000000;stroke-width:0;stroke-dasharray:none;stroke-opacity:1"
                @click="emit('ordinary')">Alert</tspan></text>
            </g>
            <text
            id="text25"
            xml:space="preserve"
            ...
            x="411.79178"
            y="229.05826"
            transform="translate(-100.93892,-126.55447)"><tspan id="tspan25" class="hover-states violet"
                sodipodi:role="line"
                x="411.79178"
                y="229.05826"
                style="cursor:pointer; font-size:18.6667px;fill-opacity:1;paint-order:stroke fill markers"
                @click="emit('brainwaves')">BRAINWAVES</tspan></text><g
            id="g25"
            ...
            sodipodi:insensitive="true"><text
                ...
                x="424.61035"
                y="558.72089"><tspan id="tspan21" class="hover-states violet"
                sodipodi:role="line"
                x="424.61035"
                y="558.72089"
                style="cursor:pointer;font-size:18.6667px;fill-opacity:1;paint-order:stroke fill markers"
                @click="emit('brainwaves')">Delta</tspan></text><text
                id="text22"
                xml:space="preserve"
                ...
                x="423.05743"
                y="476.43652"><tspan id="tspan22" class="hover-states violet"
                sodipodi:role="line"
                x="423.05743"
                y="476.43652"
                style="cursor:pointer;font-size:18.6667px;fill-opacity:1;paint-order:stroke fill markers"
                @click="emit('brainwaves')">Theta</tspan></text><text
                id="text23"
                xml:space="preserve"
                style="font-size:18.6667px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:Cantarell;letter-spacing:0.92px;fill:#c099f4;fill-opacity:1;paint-order:stroke fill markers"
                x="423.96707"
                y="375.98697"><tspan id="tspan23" class="hover-states violet"
                sodipodi:role="line"
                x="423.96707"
                y="375.98697"
                style="cursor:pointer;font-size:18.6667px;fill-opacity:1;paint-order:stroke fill markers"
                @click="emit('brainwaves')">Alpha</tspan></text><text
                id="text24"
                xml:space="preserve"
                style="font-size:18.6667px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:Cantarell;letter-spacing:0.92px;fill:#c099f4;fill-opacity:1;paint-order:stroke fill markers"
                x="433.26907"
                y="284.85797"><tspan  id="tspan24" class="hover-states violet"
                sodipodi:role="line"
                x="433.26907"
                y="284.85797"
                style="cursor:pointer;font-size:18.6667px;fill-opacity:1;paint-order:stroke fill markers"
                @click="emit('brainwaves')">Beta</tspan>
            </text>
        </g>
                <g
            id="g18"
            ...
            style="display:inline"><text
                ...
                x="108.99459"
                y="486.36197"
                transform="rotate(-15.736262)"><tspan id="tspan13" class="hover-states blue"
                sodipodi:role="line"
                x="108.99459"
                y="486.36197"
                style="cursor:pointer;font-size:14.6667px;fill-opacity:1"
                @click="emit('selves')">Consciousness</tspan></text><text
                id="text14"
                xml:space="preserve"
                style="font-size:14.6667px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:Cantarell;letter-spacing:0.92px;fill:#000000"
                x="153.3195"
                y="393.20193"
                transform="rotate(-17.411215)"><tspan id="tspan14" class="hover-states blue"
                sodipodi:role="line"
                x="153.3195"
                y="393.20193"
                style="cursor:pointer;font-size:14.6667px;fill-opacity:1"
                @click="emit('selves')">Psyche</tspan></text><text
                id="text15"
                xml:space="preserve"
                style="font-size:14.6667px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:Cantarell;letter-spacing:0.92px;fill:#000000"
                x="162.17647"
                y="325.54593"
                transform="rotate(-21.082726)"><tspan id="tspan15" class="hover-states blue"
                sodipodi:role="line"
                x="162.17647"
                y="325.54593"
                style="cursor:pointer;font-size:14.6667px;fill-opacity:1"
                @click="emit('selves')">Ego</tspan></text><text
                id="text16"
                xml:space="preserve"
                style="font-size:14.6667px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:Cantarell;letter-spacing:0.92px;fill:#000000"
                x="130.68169"
                y="242.11737"
                transform="rotate(-18.003706)"><tspan id="tspan16" class="hover-states blue"
                sodipodi:role="line"
                x="130.68169"
                y="242.11737"
                style="cursor:pointer;font-size:14.6667px;fill-opacity:1"
                @click="emit('selves')">Personality</tspan></text><text
                id="text17"
                xml:space="preserve"
                style="font-size:14.6667px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:Cantarell;letter-spacing:0.92px;fill:#000000"
                x="168.81166"
            ...
            sodipodi:insensitive="true"><text
                ...
                x="382.11453"
                y="610.90247"><tspan id="tspan1" class="hover-states"
                sodipodi:role="line"
                x="382.11453"
                y="610.90247"
                ...
                @click="emit('spiritual')">NONDUAL</tspan></text><text
                id="text5"
                xml:space="preserve"
                style="font-size:21.3333px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:Cantarell;letter-spacing:0.92px;fill-opacity:1;stroke:#000000;stroke-width:3;stroke-dasharray:none;stroke-opacity:1;paint-order:stroke fill markers"
                x="395.6539"
                y="561.27686"><tspan id="tspan5" class="hover-states"
                sodipodi:role="line"
                x="395.6539"
                y="561.27686"
                style="cursor:pointer;font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';fill-opacity:1;stroke:#000000;stroke-width:3;stroke-dasharray:none;stroke-opacity:1;paint-order:stroke fill markers"
                @click="emit('spiritual')">CAUSAL</tspan></text><text
                id="text3"
                xml:space="preserve"
                style="font-size:21.3333px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:Cantarell;letter-spacing:0.92px;fill-opacity:1;stroke:#000000;stroke-width:3;stroke-dasharray:none;stroke-opacity:1;paint-order:stroke fill markers"
                x="396.47995"
                y="514.02985"><tspan id="tspan3" class="hover-states"
                sodipodi:role="line"
                x="396.47995"
                y="514.02985"
                style="cursor:pointer;font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';fill-opacity:1;stroke:#000000;stroke-width:3;stroke-dasharray:none;stroke-opacity:1;paint-order:stroke fill markers"
                @click="emit('spiritual')">SUBTLE</tspan></text><text
                id="text4"
                xml:space="preserve"
                style="font-size:21.3333px;line-height:1.5;font-family:Cantarell;-inkscape-font-specification:Cantarell;letter-spacing:0.92px;fill-opacity:1;stroke:#000000;stroke-width:3;stroke-dasharray:none;stroke-opacity:1;paint-order:stroke fill markers"
                x="392.15906"
                y="454.97736"><tspan id="tspan4" class="hover-states"
                sodipodi:role="line"
                x="392.15906"
                y="454.97736"
                style="cursor:pointer;font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';fill-opacity:1;stroke:#000000;stroke-width:3;stroke-dasharray:none;stroke-opacity:1;paint-order:stroke fill markers"
                @click="emit('spiritual')">PSYCHIC</tspan></text><text
                id="text2"
                xml:space="preserve"
                ...
                x="398.98199"
                y="395.31964"><tspan id="tspan2" class="hover-states"
                sodipodi:role="line"
                x="398.98199"
                y="395.31964"
                ...
                @click="emit('spiritual')">GROSS</tspan></text></g><text
            id="text19"
            xml:space="preserve"
            ...
            inkscape:label="spritiualpracti"><tspan id="tspan19" class="hover-states blue"
                sodipodi:role="line"
                x="385.03699"
                y="-522.8584"
                style="cursor:pointer;font-size:17.3333px;line-height:1.6;fill-opacity:1"
                @click="emit('spiritual')">spiritual practice </tspan></text>
                <text
            id="text47"
            xml:space="preserve"
            ...
            x="510.50623"
            y="295.13605">
            <tspan id="tspan47" class="hover-states black"
                sodipodi:role="line"
                x="510.50623"
                y="295.13605"
                ...
                @click="emit('spiritual')">awakening</tspan></text><text
            id="text48"
            xml:space="preserve"
            style="font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:16px;line-height:1.6;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';text-align:start;letter-spacing:0.92px;text-anchor:start;display:inline;fill:#000000;fill-opacity:1;stroke:#e7b500;stroke-width:0;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none;stroke-opacity:1"
            x="528.50439"
            y="353.5126"><tspan id="tspan48" class="hover-states black"
                sodipodi:role="line"
                x="528.50439"
                y="353.5126"
                ...
                @click="emit('spiritual')">vision</tspan></text><text
            id="text49"
            xml:space="preserve"
            style="font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:16px;line-height:1.6;font-family:Cantarell;-inkscape-font-specification:'Cantarell Bold';text-align:start;letter-spacing:0.92px;text-anchor:start;display:inline;fill:#000000;fill-opacity:1;stroke:#e7b500;stroke-width:0;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none;stroke-opacity:1"
            x="494.1463"
            y="401.66351"><tspan id="tspan49" class="hover-states black"
                sodipodi:role="line"
                x="494.1463"
                y="401.66351"
            ...
            x="553.56616"
            y="469.91791"><tspan id="tspan6" class="hover-states"
                sodipodi:role="line"
                x="557.28613"
                y="469.91791"
                ...
                @click="emit('spiritual')">SPIRITUAL </tspan></text><text
            id="text26"
            xml:space="preserve"
