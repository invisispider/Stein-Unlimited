...
<template>
    <section class="technomancy">
        ...
        <ul>
            ...
            <li>Automated reports using Python, Google Sheets & Google APIs</li>
        ...
        <ul>
            ...
            <li>Agencies & B2B service providers</li>
            <li>Coaches, consultants, and solo operators</li>
        </ul>

        <h3>🛠️ My Stack:</h3>
        <ul>
            <li>Python (Flask or FastAPI), SQL/NoSQL</li>
            <li>Google Workspace / Apps Script</li>
        ...
        <ul>
            ...
            <li>Database development & query writing</li>
            <li>Google Apps Script & spreadsheet automation</li>
            <li>Linux servers, cron jobs, CLI tools</li>
            <li>LAMP/PHP, Node.js, TypeScript</li>
