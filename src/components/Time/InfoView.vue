...
<template>
    <div class="info-template">
        <div v-if="props.infoview=='unlimited'">
            <h1>Better Time Keeping</h1>
            <p>The fastest way to introduce the unLimited clock and calendar 
                framework is to expose the problems baked into the system we use now. 
            ...
            <p>
            <b>Hours</b> divide Earth's daily spin into 24 hours. 
            Each has 60 <b>minutes</b>, each with 60 <b>seconds</b>. 
            Base-24 and base-60 wrap nicely around a circle and divide cleanly, 
            but they make life harder for creatures who count on ten fingers and 
            think in base-10.
            </p>
            <h3>Days aren't round?</h3>
            <p> 
                Early sundials traced the progress of a pole's shadow as the sun crossed
                the sky, resulting in circular depictions of the light half of a day. 
                You might assume your clock's hour hand mirrors Earth's rotation,
                but it actually goes around twice per day, and the 12-hour circle has no meaning. 
            </p>
            <h3>A Scheduling Grid Clock</h3> 
            <p>
            Pie charts are great for certain applications, like when you need to 
            eyeball relative proportions. They are bad clocks.
            They're terrible for seeing *what happens when*. 
            When we plan our day, we use lists and symmetrical grids — not three 
            spinning pie charts (the clock hands.)
            </p>
            <h3>Designed for Us</h3>
            <h4>10 Sessions = 1 Day</h4>
            <h4>100 Moments = 10 Whiles = 1 Session</h4>
            <p>
            In unLimited time, everything is base-10. 
            "Session," "Moment," "While," and "Instant" are names you already use. 
            We just made them official. No more hours, minutes, and seconds — and no need to drag 
            ancient baggage with us.
            </p>
            <h4>Why AM and PM?</h4>
            <p>
            Splitting hours into AM and PM gets closer to base-10, but adds a daily reset and extra metadata.
            How many people even know what AM and PM mean? 
            Why are we still writing time in a dead language?
            </p>
            <h2>📆 What's wrong with my calendar? ☹️</h2>
            <p>
            Most of us don't want to work exactly five out of every seven days — and our preference changes week to week.
            If everyone hates Monday, just get rid of it. 
            In unLimited time, a Cycle is five days. Five fingers on a hand.
            </p>
            <p>
            Months have weird names and unpredictable lengths. 
            They don’t really track anything.
            In unLimited time, <b>Habits</b> are always 45 days long, and they divide the seasons cleanly.
            </p>
            <p>
            Holidays are clumped oddly and show up at confusing times. 
            They’re often culturally exclusive, too. 
            In unLimited time, every Habit begins with a simple, secular <b>Holiday</b> named after the Habit itself. 
            Customize from there.
            </p>
            <p>
            Ancient history is hard to visualize — you have to count backward across BC/AD.
            unLimited time starts 12,000 years ago, when timekeeping actually started to matter, not 2,000 years ago when Christians made it official.
            </p>
            <h3>Wait — the start of the year isn’t aligned to anything?</h3>
            <p>
            Not really. It's close to the solstice... but off by a few days. 
            We fix that.
            In unLimited time, the year starts *on* the solstice and splits cleanly into four seasons.
            Adding the five-day <b>newZen Cycle</b> means Roman and unLimited calendars only mismatch by about three days (depending on leap years).
            </p>
            <h3>Sold. 👍🏿 How can I use this?</h3>
            <p>
            Try it out. Bookmark this demo and use it as your own unLimited clock and calendar. 
            If you're a developer, integrate it into your apps or refactor this code freely.
            This page calculates unLimited Time using standard JavaScript dates — no need to reinvent the wheel.
            </p>
            <h3>Contribute</h3>
            <p>
            Want to help? Donate via Venmo and leave a note with the features you'd like to see.
            We aim to build unLimited scheduling and life timeline visualization apps.
            </p>
        </div>
        <div v-else-if="infoview=='reading'">
